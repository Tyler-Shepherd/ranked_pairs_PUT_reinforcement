...
class RL_base_PUT_agent_experience_replay():
    ...
    '''
    def reinforcement_loop(self, agent, env0, f_train_until_found_all_winners = 0, true_winners = set(), filename=None):
        # Initialize
