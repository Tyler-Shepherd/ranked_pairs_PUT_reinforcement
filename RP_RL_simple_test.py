...
if __name__ == '__main__':
    ...
    agent.load_model("C:\\Users\shepht2\Documents\School\Masters\STV Ranked Pairs\\RL\\results\\9-9\\results_RP_RL_main618347245_model.pth.tar")
    ...
    agent.K = frozenset({0,1,2,3,4,5,6,7,8})
